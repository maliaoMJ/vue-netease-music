        ...
        <div>
          <div class="banner slider-wrapper">
            <slider v-if="bannerImgs">
              <div  v-for="item in bannerImgs" >
                <a href="">
                  <img :src="item.pic" :title="item.typeTitle" alt="">
                </a>
              </div>
            </slider>
          </div>
          ...
          <div class="music_menu" v-if="musicMenuData">
            <div class="menu_item" v-for="item in musicMenuData">
              <div class="playCount">
                <img :src="item.picUrl" alt="" :title="item.copywriter">
                <div class="lv">
          ...
          <div class="music_menu" v-if="musicMenuData">
            <div class="menu_item" v-for="item in newMv">
              <div class="playCount">
                <img :src="item.cover" alt="" :title="item.artistName">
                <div class="lv">
                  <icon class="icon" name="headphones"></icon>&nbsp;{{item.playCount}}&nbsp;&nbsp;
                </div>
              </div>
...
//        http://localhost:3000/personalized
      ...
      _getNewMv() {
        this.$http.get('http://localhost:3000/mv/first?limit=6')
          .then((response) => {
